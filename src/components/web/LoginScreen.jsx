// src/components/web/LoginScreen.jsx
...
const LoginScreen = () => {
    const title = `Login Cliente Web`;
    const registerText =  'Cadastrar' ;
    const registerHref = '/register-web';
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await authService.login(username, password, 'web'); // Usa authService.login
            console.log("Login bem-sucedido:", response);
            alert("Login bem-sucedido! Redirecionando para o Dashboard...");

            // Redirecionar para o dashboard web após login bem-sucedido
            navigate('/dashboard-web'); // Redirecionamento usando useNavigate
